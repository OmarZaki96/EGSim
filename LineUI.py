...
class LineWindow(QDialog, FROM_Line_Main):
    ...
    def load_fields(self,line):
        ...
        self.Line_length.setText(str(round(line.Line_length,6)))
        self.Line_OD.setText(str(round(line.Line_OD,6)))
        self.Line_ID.setText(str(round(line.Line_ID,6)))
        self.Line_insulation_t.setText(str(round(line.Line_insulation_t,6)))
        self.Line_e_D.setText(str(line.Line_e_D))
        self.Line_tube_k.setText(str(round(line.Line_tube_k,6)))
        self.Line_insulation_k.setText(str(round(line.Line_insulation_k,6)))
        self.Line_surrounding_T.setText(str(round(line.Line_surrounding_T-273.15,6)))
        self.Line_N_segments.setValue(line.Line_N_segments)
        self.Line_q_tolerance.setValue(line.Line_q_tolerance*100)
        self.Line_DP_correction.setText(str(round(line.Line_DP_correction,6)))
        self.Line_HT_correction.setText(str(round(line.Line_HT_correction,6)))
        self.Line_surrounding_HTC.setText(str(round(line.Line_surrounding_HTC,6)))
